    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            <div class="p-6 border-b border-gray-200">
                <h2 class="text-xl font-semibold text-gray-900">Modifica Informazioni Progetto</h2>
            </div>
            ...
            <form action="{{ route('projects.update', $project) }}" method="POST" class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <textarea id="description" 
                              name="description" 
                              rows="3"
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('description') border-red-500 @enderror">{{ old('description', $project->description) }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                    ...
                    <div>
                        ...
                        <select id="assigned_user_id" 
                            ...
                            @foreach($users as $user)
                                <option value="{{ $user->id }}" {{ old('assigned_user_id', $project->assigned_user_id) == $user->id ? 'selected' : '' }}>
                ...
                <div class="border-t border-gray-200 pt-6">
                        ...
                        <div class="flex space-x-6">
                            <label class="flex items-center">
                                <input type="radio" 
                                       name="payment_type" 
                                       value="one_time" 
                                       {{ old('payment_type', $project->payment_type) === 'one_time' ? 'checked' : '' }}
                            ...
                            <label class="flex items-center">
                                <input type="radio" 
                                       name="payment_type" 
                                       value="installments" 
                                       {{ old('payment_type', $project->payment_type) === 'installments' ? 'checked' : '' }}
                                       class="text-blue-600 focus:ring-blue-500"
                                       onchange="togglePaymentFields()">
                    ...
                    <!-- Installment Fields -->
                    <div id="installment-fields" class="space-y-6">
                        <!-- Down Payment -->
                        <div>
                            <label class="flex items-center">
                                <input type="checkbox" 
                                       ...
                                       value="1"
                                       {{ old('has_down_payment', $project->has_down_payment) ? 'checked' : '' }}
                                       class="text-blue-600 focus:ring-blue-500"
                        ...
                        <div id="down-payment-amount">
                            ...
                            <input type="number" 
                                   ...
                                   step="0.01"
                                   min="0"
                                   value="{{ old('down_payment_amount', $project->down_payment_amount) }}"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <select id="payment_frequency" 
                                    ...
                                    @foreach(App\Models\Project::getPaymentFrequencies() as $key => $frequency)
                                        <option value="{{ $key }}" {{ old('payment_frequency', $project->payment_frequency) === $key ? 'selected' : '' }}>
                                            {{ $frequency }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <input type="number" 
                                       ...
                                       step="0.01"
                                       min="0"
                                       value="{{ old('installment_amount', $project->installment_amount) }}"
                            ...
                            <div>
                                ...
                                <input type="number" 
                                       ...
                                       min="1"
                                       value="{{ old('installment_count', $project->installment_count) }}"
